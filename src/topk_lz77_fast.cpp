...
struct Compressor : public TopkCompressor {
    ...
    virtual void init_result(pm::Result& result) override {
        result.add("algo", "topk-lz77-fast");
    ...
    virtual void compress(iopp::FileInputStream& in, iopp::FileOutputStream& out, pm::Result& result) override {
        topk_compress_lz77<true>(in.begin(), in.end(), iopp::bitwise_output_to(out), k, window, sketch_count, sketch_rows, sketch_columns, block_size, threshold, result);
    }
